...
use Modules\Catalog\Plm\Services\CatalogPolicy;
...
class HomePassController extends ApiController
{
    public function __construct(
        ...
        private readonly \Modules\Catalog\Network\Services\HomePassTopologyService $topology,
    ) {}
    ...
    {
        return ApiResponse::item((new \Modules\Catalog\Network\Services\Geo\GeoClient())->enrichFromGeo($homepass));
    }
    ...
    public function eligible(Request $request): JsonResponse
    {
        ...
        $sellableCodes = \Modules\Catalog\Network\Models\HomePassStatusCode::query()
