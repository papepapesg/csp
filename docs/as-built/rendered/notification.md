> 📱 **Rendered view** — diagrams below are images so they show in the GitHub app. Editable source (with mermaid): [`../notification.md`](../notification.md).
...
![diagram](img/notification_1.png)
...
![diagram](img/notification_2.png)
...
![diagram](img/notification_3.png)
...
![diagram](img/notification_4.png)
...
![diagram](img/notification_5.png)
...
![diagram](img/notification_6.png)
