...
/**
 * Simple PLM config catalogs: adjustment_type (PLM-CFG-05/08), voice_tariff
 * (PLM-CFG-07), equipment_type (PLM-CFG-06). Each is an operator-scoped reference
 * table consumed by billing / OSR at runtime.
 *
 * PLM-CFG-03 wallet_type is NOT here — it is a rich catalog (lifecycle, charging
 * rules) owned by BillingWallet's create_wallet_type migration, not a simple row.
 */
