...
```mermaid
flowchart LR
    HP["homepass hp_1<br/>technology=GPON"] --> EP["service_management_endpoints<br/>DATA at OLT-NRB-WTL-01 port 1"]
    EP --> TGT["GPON target plane<br/>HUAWEI_NCE_GPON_KE"]
    TGT --> ADP["adapter pushes the subscriber"]
```
