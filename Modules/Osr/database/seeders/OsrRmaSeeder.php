            ...
            [
                ...
                'graph' => [
                    'nodes' => [
                        ...
                        ['id' => 'gw_rec', 'type' => 'exclusiveGateway', 'position' => ['x' => 1040, 'y' => 40], 'data' => ['label' => 'Recovered?']],
                        ['id' => 'recover', 'type' => 'serviceTask', 'position' => ['x' => 1200, 'y' => 0], 'data' => ['label' => 'Recover source', 'topic' => 'osr.recover-source']],
                        ['id' => 'provision', 'type' => 'serviceTask', 'position' => ['x' => 1360, 'y' => 0], 'data' => ['label' => 'Provision OSS', 'topic' => 'osr.provision-swap']],
                        ['id' => 'complete', 'type' => 'serviceTask', 'position' => ['x' => 1520, 'y' => 0], 'data' => ['label' => 'Complete', 'topic' => 'osr.complete-swap']],
                        ['id' => 'cwr', 'type' => 'serviceTask', 'position' => ['x' => 1200, 'y' => 120], 'data' => ['label' => 'Complete (no recovery)', 'topic' => 'osr.complete-without-recovery']],
                        ['id' => 'fail', 'type' => 'serviceTask', 'position' => ['x' => 520, 'y' => 180], 'data' => ['label' => 'Fail', 'topic' => 'osr.fail-swap']],
                        ['id' => 'end_ok', 'type' => 'endEvent', 'position' => ['x' => 1680, 'y' => 40], 'data' => ['label' => 'Completed']],
                    ...
                    'edges' => [
                        ...
                        ['id' => 'e7', 'source' => 'await', 'target' => 'gw_rec'],
                        ['id' => 'e7b', 'source' => 'gw_rec', 'target' => 'recover', 'data' => ['condition' => ['var' => 'recovered', 'op' => 'truthy']]],
                        ['id' => 'e7c', 'source' => 'gw_rec', 'target' => 'cwr', 'data' => ['default' => true]],
                        ['id' => 'e8', 'source' => 'recover', 'target' => 'provision'],
                        ['id' => 'e9', 'source' => 'provision', 'target' => 'complete'],
                        ['id' => 'e10', 'source' => 'complete', 'target' => 'end_ok'],
                        ['id' => 'e10b', 'source' => 'cwr', 'target' => 'end_ok'],
