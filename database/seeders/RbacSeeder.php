...
class RbacSeeder extends Seeder
{
    ...
    private const PERMISSIONS = [
        ...
        'invoice.read', 'payment.read', 'wallet.read', 'adjustment.create', 'adjustment.approve',
    ...
    private const ROLES = [
        ...
        'BILLING_OPERATOR' => ['invoice.read', 'payment.read', 'wallet.read', 'adjustment.create', 'customer.read', 'subscription.read'],
        'BILLING_LEAD' => ['invoice.read', 'payment.read', 'wallet.read', 'adjustment.create', 'adjustment.approve', 'customer.read', 'subscription.read', 'report.view'],
