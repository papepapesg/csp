...
/**
 * BIL-02-TAX-01: payment-triggered tax invoice generation (proportional postpaid + inclusive
 * prepaid), the async signing state machine, transient retry → give-up, validation parking,
 * and signed-cancellation dual approval.
 */
